...
//$mpdf->SetProtection(array('copy','save','modify','annot-forms'));
//$mpdf->SetProtection(array('copy','save','modify','annot-forms'),'',null,128);
//$mpdf->SetProtection(array('copy','save','modify','annot-forms','fill-forms','extract','assemble','print-highres'),'',null);
...
<div style="padding: 1em; margin-bottom: 1em; font-family: arial; border-bottom: 42px double #666; border-left: 16px double red border-top: 28px double #0F0; border-right: 36px double #00F; ">Hallo World</div>

<div style="padding: 1em; margin-bottom: 1em; font-family: arial; border-bottom: 42px double #666; border-left: 16px solid red border-top: 28px solid #0F0; border-right: 36px double #00F; ">Hallo World</div>

<div style="padding: 1em; margin-bottom: 1em; font-family: arial; border-bottom: 42px solid #666; border-left: 16px double red border-top: 28px double #0F0; border-right: 36px solid #00F; ">Hallo World</div>

</div>

<table style="border-collapse: collapse;"><tr>
<td style="font-family: arial; border-bottom: 42px double #0FF; border-left: 16px double red border-top: 28px double #0F0; border-right: 16px double #00F; "> A whole new world </td>
</tr>
</table>
...
<table style="border-collapse: none;"><tr>
<td style="font-family: arial; border: 16px double red border-top: 16px double #0F0;"> A whole new world </td>
</tr>
</table>
